...
from model.losses import (get_masked_ptc_loss, get_seg_loss, get_energy_loss, DRELoss_neg, SRELoss_neg,
...
def train(args=None):
    ...
    for n_iter in range(args.max_iters):
        ...
        CLE_loss = DRELoss_neg(temp=0.5).cuda()
        UNE_loss = SRELoss_neg(temp=0.5).cuda()
